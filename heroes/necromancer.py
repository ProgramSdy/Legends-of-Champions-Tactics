...
# Battling Strategy_________________________________________________________
    ...
    def strategy_0(self):
        ...
        self.probability_life_drain = 0.15
        self.probability_unholy_frenzy = 0

    def strategy_1(self):
        self.probability_command_skeleton = 0
        self.probability_life_drain = 0.85
        self.probability_unholy_frenzy = 0.15

    def strategy_2(self):
        self.probability_command_skeleton = 0
        self.probability_life_drain = 1
        self.probability_unholy_frenzy = 0

    def strategy_3(self):
        self.probability_command_skeleton = 0
        self.probability_life_drain = 0
    ...
    def ai_choose_skill(self, opponents, allies):
        ...
        skill_weights = [self.probability_command_skeleton, self.probability_life_drain, self.probability_unholy_frenzy]
