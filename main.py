...
def main():
    ...
    for hero in player_heroes:
      ...
      if hero.name == 'Player 3':
        hero.is_player_controlled = False
    '''
    Player_1 = Paladin_Comprehensiveness(sys_init, "Andonidas", "Group_A", True)
    ...
    '''
    Galahad = Priest_Comprehensiveness(sys_init, "Bors", "Group_B", False)
    Vanishan = Priest_Discipline(sys_init,"Vanishan", "Group_B", False)
