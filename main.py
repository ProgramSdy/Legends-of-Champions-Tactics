...
def main():
    ...
    #'''
    Player_1 = Necromancer_Flesh_Puppeteer(sys_init, "Arthas", "Group_A", True)
    Player_2 = Warlock_Comprehensiveness(sys_init, "Black Heart", "Group_A", True)
    ...
    '''
    #'''
    Aldric = Necromancer_Necromancy(sys_init, "Sashein", "Group_B", False)
